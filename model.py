...
from ops import MultiPRNNCell


class SequenceClassifier:

    def __init__(self, inputs, labels, num_hidden, cell_type, keep_prob=1.0,
    ...
    def logits(self):
        ...
        relevant = self._last_relevant(outputs, self.sequence_length)
